...
#import "Helpers/BufferedAudioBus.hpp"
#import "AUv3LabDSPKernel.hpp"
#import "Helpers/AUv3LabDSPKernelAdapter.h"

@implementation AUv3LabDSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AUv3LabDSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block AUv3LabDSPKernel *state = &_kernel;
